...
const InclusionsStep: React.FC<InclusionsStepProps> = ({ tour, setTour, errors, isLoading }) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4 flex items-start">
        <Check className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" />
        <div>
          <h4 className="text-xs sm:text-sm font-medium text-green-800 mb-1">Your Tour Information Will Be Saved</h4>
      ...
      <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg sm:rounded-xl border border-gray-100">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-800">What's Included</h3>
        </div>
        ...
        <div className="mb-4 sm:mb-6 bg-green-50 p-3 sm:p-4 rounded-lg">
          <p className="text-xs sm:text-sm font-medium text-green-800 mb-2">Quick Add Common Inclusions</p>
          <div className="flex flex-wrap gap-1 sm:gap-2">
            {commonInclusions.map(item => (
              <button
                ...
                className="px-2 sm:px-3 py-1 sm:py-1.5 bg-white text-green-700 border border-green-200 rounded hover:bg-green-100 text-xs sm:text-sm flex items-center gap-1 transition-colors shadow-sm"
              >
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          {(Array.isArray(tour.included) ? tour.included : []).map((item: string, index: number) => (
            <div key={index} className="flex items-center gap-2 sm:gap-3">
              <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-50 text-green-600 flex items-center justify-center flex-shrink-0">
              ...
              <input
                ...
                className="flex-1 min-w-0 block w-full px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-500 focus:border-brand-500 text-xs sm:text-sm"
              ...
              <button
                ...
                disabled={isLoading}
                className="p-1 sm:p-1.5 rounded-md text-gray-500 hover:text-red-600 hover:bg-red-50"
              >
          ...
          <button
            ...
            disabled={isLoading}
            className="mt-2 flex items-center gap-1 sm:gap-1.5 text-xs sm:text-sm text-brand-600 hover:text-brand-800"
          >
          ...
          {(!Array.isArray(tour.included) || tour.included.length === 0) && (
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6 text-center">
              <p className="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">No inclusions added yet</p>
              <div className="flex flex-wrap gap-2 justify-center">
                <button
                  type="button"
                  onClick={() => addAllCommonItems('included', commonInclusions)}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-brand-600 text-white rounded-md hover:bg-brand-700 text-xs sm:text-sm flex items-center gap-1 sm:gap-2 transition-colors mx-auto"
                >
                  <Plus className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
      ...
      <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg sm:rounded-xl border border-gray-100">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-800">What's Not Included</h3>
        </div>
        ...
        <div className="mb-4 sm:mb-6 bg-red-50 p-3 sm:p-4 rounded-lg">
          <p className="text-xs sm:text-sm font-medium text-red-800 mb-2">Quick Add Common Exclusions</p>
          <div className="flex flex-wrap gap-1 sm:gap-2">
            {commonExclusions.map(item => (
              <button
                ...
                className="px-2 sm:px-3 py-1 sm:py-1.5 bg-white text-red-700 border border-red-200 rounded hover:bg-red-100 text-xs sm:text-sm flex items-center gap-1 transition-colors shadow-sm"
              >
                <Plus className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                {item}
              </button>
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          {(Array.isArray(tour.excluded) ? tour.excluded : []).map((item: string, index: number) => (
            <div key={index} className="flex items-center gap-2 sm:gap-3">
              <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-red-50 text-red-500 flex items-center justify-center flex-shrink-0">
          ...
          {(!Array.isArray(tour.excluded) || tour.excluded.length === 0) && (
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6 text-center">
              <p className="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">No exclusions added yet</p>
              <div className="flex flex-wrap gap-2 justify-center">
                <button
                  type="button"
                  onClick={() => addAllCommonItems('excluded', commonExclusions)}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-red-600 text-white rounded-md hover:bg-red-700 text-xs sm:text-sm flex items-center gap-1 sm:gap-2 transition-colors mx-auto"
                >
                  <Plus className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 sm:p-4 flex items-start">
        <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" />
        <div>
          <h4 className="text-xs sm:text-sm font-medium text-amber-800 mb-1">Ready to Submit Your Tour?</h4>
          ...
          <div className="flex items-center gap-1 text-xs sm:text-sm text-amber-800">

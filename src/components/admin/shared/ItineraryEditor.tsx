...
import { DayItinerary } from '../../../hooks/useItineraryEditor';
...
interface ItineraryEditorProps {
  ...
  onChangeDay: (index: number, field: keyof DayItinerary, value: any) => void;
  onAddActivity: (dayIndex: number) => void;
  onRemoveActivity: (dayIndex: number, activityIndex: number) => void;
  onChangeActivity: (dayIndex: number, activityIndex: number, value: string) => void;
  onToggleMeal: (dayIndex: number, meal: string) => void;
}
...
const ItineraryEditor: React.FC<ItineraryEditorProps> = ({
  ...
  return (
    <DetailsPanelLayout 
      title="Itinerary" 
      description="Build a daily schedule for your tour or event"
    >
            ...
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={day.title}
                    onChange={(e) => onChangeDay(dayIndex, 'title', e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onChangeDay(dayIndex, 'accommodation', e.target.value)}
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={(e) => onChangeDay(dayIndex, 'description', e.target.value)}
                    ...
                    <div key={activityIndex} className="flex items-center">
                      ...
                      <div className="flex-grow">
                        <input
                          type="text"
                          value={activity}
                          onChange={(e) => onChangeActivity(dayIndex, activityIndex, e.target.value)}
                  ...
                  {['breakfast', 'lunch', 'dinner'].map((meal) => (
                    <div key={meal} className="flex items-center">
                      <input
                        ...
                        onChange={() => onToggleMeal(dayIndex, meal)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={day.distance || ''}
                    onChange={(e) => onChangeDay(dayIndex, 'distance', e.target.value)}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={day.elevation || ''}
                    onChange={(e) => onChangeDay(dayIndex, 'elevation', e.target.value)}

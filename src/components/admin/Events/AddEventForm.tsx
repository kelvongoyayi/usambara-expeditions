  ...
  return (
    <div className="w-full mx-auto px-2 sm:px-4 py-4 sm:py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 w-full">
        {/* Step Progress Indicator - Updated UI to match tour form */}
        <div className="mb-6 sm:mb-10">
          <div className="relative flex items-start justify-between overflow-x-auto pb-4 sm:pb-2">
            ...
            {steps.map((step, index) => {
              ...
              const isCompleted = steps.findIndex(s => s.id === currentStep) > index || completedSteps.includes(step.id);
                ...
                <div key={step.id} className="flex-1 flex flex-col items-center min-w-[70px]">
                  ...
                  <div className="relative flex items-center w-full justify-center">
                    ...
                    <button
                      ...
                      disabled={!isActive && !completedSteps.includes(step.id)}
                      className={`
                        ...
                        ${isActive 
                          ...
                          : isCompleted 
                            ? 'bg-accent-600 text-white cursor-pointer' 
